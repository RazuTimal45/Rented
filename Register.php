...
<body>
      ...
      <div class="container-fluid">
        <div class="row mt-3 justify-content-center mt-5 pb-4">
            <div class="col-md-5 mt-2">
                <img src="./images/right.jpg"style="border-radius:20px;" height="500px" width="400px" class="img-fluid" alt="">
            </div>
            <div class="col-md-5 mt-5">
                <form action="#" method="post" style="color:rgb(18, 69, 83);">
                    <div class="mb-3">
                    ...
                    <div class="mb-3 form-check">
                      ...
                      <div class="row justify-content-between">
                        <div class="col-md-2">
                            <input type="submit" class="btn btn-primary " tabindex="-1" role="button" name="signup" value="signup" aria-disabled="true">
                        </div>
                        <div class="col-md-2">
                            <a href="login.php" class="btn btn-success " tabindex="-1" role="button" aria-disabled="true">login</a>
                        </div>
                      </div>
                  </form>
            </div>
...
<?php
  if(isset($_POST['signup'])){
    ...
    $insertquery = "INSERT INTO `signup` (`username`, `emailaddress`,`password`) VALUES ( '$username', '$email', '$password')";
